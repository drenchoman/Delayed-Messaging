...
exports.seed = async function (knex) {
  ...
  await knex('messages').insert([
    ...
    },
    {
      ...
      I don't think you really see how special and awe-inspiring you are, 
      and I am here to remind you of that.
      
      I am here to tell you that women like you are so rare and precious 
      and that I feel truly blessed to have you in my life.
      
      You inspire me because you are not afraid to be yourself. And I know 
      you weren't born that way. I know that life has beaten and bent you. 
      I know it took you a long time to learned to truly love yourself.
      
      You had to build your confidence from scratch. But you managed. Somewhere 
      down the line, you realized that it's not about being perfect—it's about 
      being you. It's about accepting yourself.
      
      You taught me that you don't always have to be strong. You are allowed to 
      have a meltdown from time to time. You are allowed to break into pieces. 
      That's OK as long as you keep picking yourself up.
      
      Not giving up on yourself is what it's all about, and it doesn't matter how 
      long it takes. It's the end result that counts.
      
      You inspire me because no matter how many curve balls life threw at you, 
      you always found the moments to smile.
      
      Even in your darkest hour, you keep a positive mind. You always enjoy the 
      small fragments of light that come your way.
      
      You know that there are always some good days just around the corner, waiting 
      for you, waiting for your loved ones, and it's only a matter of time before 
      you get there.`,
      subject: 'You smell',
      active_time: today,
      read: false,
